...
为手机与电脑设计的静态小说阅读器。豆沙绿（默认）、纸色、明亮和夜读四种主题，支持黑体／宋体切换、字号、行距、段距、正文宽度、专注模式、可选的 20 分钟休息提醒、章节搜索、书签、键盘方向键分页和浏览器本地阅读进度。调整排版后会尽量保持当前段落。无需后端或第三方 CDN。进度和书签按设备、浏览器分别保存，不跨设备同步。
